...
// Fake Data
import { conversations } from "~/containers/admin/chats/data/convo.json";
            ...
            <div className="sticky top-0 z-10 -mx-4 bg-background px-4 pb-3 shadow-md sm:static sm:z-auto sm:mx-0 sm:p-0 sm:shadow-none">
              <div className="flex items-center justify-between py-2">
                ...
                <Button size="icon" variant="ghost" className="rounded-lg">
                  <Pencil1Icon className="size-6 text-muted-foreground" />
                </Button>
              </div>
              ...
              <label className="flex h-12 w-full items-center space-x-0 rounded-md border border-input pl-2 focus-within:outline-none focus-within:ring-1 focus-within:ring-ring">
                <MagnifyingGlassIcon className="mr-2 size-4 text-slate-500" />
            ...
            <div className="mb-1 flex flex-none justify-between rounded-t-md bg-secondary p-4 shadow-lg">
              ...
              <div className="-mr-1 flex items-center gap-1 lg:gap-2">
                ...
                <Button
                  ...
                  className="hidden size-8 rounded-full sm:inline-flex lg:size-10"
                >
                  <MobileIcon className="size-5 text-muted-foreground" />
                </Button>
                <Button
                  size="icon"
                  variant="ghost"
                ...
                >
                  <DotsVerticalIcon className="size-5 text-muted-foreground" />
                </Button>
              </div>
            </div>
            ...
            <div className="flex flex-1 flex-col gap-2 rounded-md px-4 pb-4 pt-0">
              ...
              <form className="flex w-full flex-none gap-2">
                <div className="flex flex-1 items-center gap-2 rounded-md border border-input px-2 py-1 focus-within:outline-none focus-within:ring-1 focus-within:ring-ring lg:gap-4">
                  <div className="space-x-1">
                    ...
                    <Button
                      ...
                      className="hidden h-8 rounded-md lg:inline-flex"
                    >
                      <Link1Icon className="size-5 text-muted-foreground" />
                    </Button>
                  </div>
                ...
                <Button className="h-full sm:hidden">
                  <PaperPlaneIcon className="size-4.5" /> Send
                </Button>
              </form>
            </div>
          </div>
